...
//        $this->middleware('auth');
    ...
    public function index()
    {
        try{
            ...
            return view('manager.permission', compact('roles'));
        }catch (\Exception $e) {
            $bug = $e->getMessage();
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            if($permission){ 
                return redirect()->route('permission')->with('success', 'Permission created succesfully!');
            }else{
                return redirect()->route('permission')->with('error', 'Failed to create permission! Try again.');
            }
        }catch (\Exception $e) {
            $bug = $e->getMessage();
            return redirect()->back()->with('error', $bug);
    ...
    public function delete($id)
    {
        ...
        if($permission){
            ...
            return redirect()->route('permission')->with('success', 'Permission deleted!');
        }else{
            return redirect('404');
        }
    }
