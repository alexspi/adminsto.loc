      ...
      <ul class="horizontal-menu">
        ...
        @else
          ...
          <li class="level-menu outside">
            <a class="nav-link" href="#!"><i data-feather="inbox"></i><span>Быстрое меню</span></a>
            <ul class="header-level-menu menu-to-be-close">
              <li>
                <a href="{{route('users')}}" data-original-title="" title=""> <i data-feather="git-pull-request"></i><span>Менеджеры </span></a>
              </li>
{{--              <li>--}}
{{--                <a href="#!" data-original-title="" title=""> <i data-feather="users"></i><span>Клиенты</span></a>--}}
{{--                <ul class="header-level-sub-menu">--}}
{{--                  <li>--}}
{{--                    <a href="{{route('clients.arhive')}}" data-original-title="" title=""> <i data-feather="user-minus"></i><span>Архивы</span></a>--}}
{{--                  </li>--}}
{{--                  <li>--}}
{{--                    <a href="{{route('clients')}}" data-original-title="" title=""> <i data-feather="user-check"></i><span>Действующие</span></a>--}}
{{--                  </li>--}}
{{--                  <li>--}}
{{--                    <a href="{{route('client.create')}}" data-original-title="" title=""> <i data-feather="user-plus"></i><span>Создать</span></a>--}}
{{--                  </li>--}}
{{--                </ul>--}}
{{--              </li>--}}
              @endrole
