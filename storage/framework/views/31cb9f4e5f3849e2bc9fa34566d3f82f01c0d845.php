        ...
        <?php else: ?>
          ...
          <li class="level-menu outside">
            ...
            <ul class="header-level-menu menu-to-be-close">
              <li>
                <a href="<?php echo e(route('users')); ?>" data-original-title="" title=""> <i data-feather="git-pull-request"></i><span>Менеджеры </span></a>
              </li>
      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          ...
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li><a href="<?php echo e(route('logout')); ?>"><i data-feather="log-in"> </i><span>Выход</span></a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<?php /**PATH E:\OSpanel\OpenServer\domains\8uglov.loc\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>